...
def test_the_registered_expectations_hold():
    ...
    r2 = c["R2"]["stored"]
    assert all(e["disclosure"] == "use_only" and not e["assertable"] for e in r2["edges"] + r2["episodes"])
    ...
    assert by_obj["Braga"]["disclosure"] == "quarantined" and by_obj["carpenter"]["disclosure"] == "use_only"
