...
DISPOSITIONS = {
 ...
 ("src/veracium/__init__.py", "Memory.forget", "forget_user", "c5d9e9e2da39"):
   (W, "**all** — irreversible erasure", YES, "clean — erasure is the contract", "`test_forget_erases_everything_and_only_that_user`"),
...
STATES = {
  ...
  ("src/veracium/__init__.py", "Memory.record_outcome", "add_episode", "02cff46798fc"): "open",
  ...
  ("src/veracium/graph.py", "apply_supersession", "add_edge", "b766ab223c71"): "open",
  ...
  ("src/veracium/lifecycle.py", "consolidate", "delete_episode", "d24901a8b7ea"): "open",
