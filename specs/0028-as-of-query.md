...
| **V-NO-UPGRADE** | no §4b row returns an outcome stronger than 0030's verdict allows | per-row assertion against 0030's classification | **CHECKED** (implemented 2026-09-08) `tests/test_0028_resolution.py::test_v_no_upgrade_no_row_outranks_the_0030_verdict` (one cell per registered reason) |
