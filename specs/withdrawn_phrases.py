...
WITHDRAWN = [
    ...
    ("0014-references-removed",
     ...
     "R12-3/0014: reference fields are NORMALIZED-AND-COMPARED (remap-resolved back to source ids), never removed — removal would accept a file pointing lineage at a different source record",
     "specs/0014 §2c output-index row (three-set projection)"),
