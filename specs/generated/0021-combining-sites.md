...
| `src/veracium/store/sqlite.py` | `_invalidate_edge_row` | `UPDATE edges` | **yes** | absorption · supersession | retires a prior BECAUSE of the incoming — absorbed_duplicate only within one scope (§4c); superseded is scope-blind (§3) |
