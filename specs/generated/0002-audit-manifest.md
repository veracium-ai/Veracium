...
| `src/veracium/__init__.py:629` | `Memory.correct()` | `invalidate_edge` | `c81beaca32cb` | `open_moved` | write-time | `active`, `invalidation_reason=corrected` | act | ➡️ **MOVED to `0003` §1b** — this is a supersession path | tracked as 0003 I9/I10 [M7-correct] |
| `src/veracium/__init__.py:638` | `Memory.correct()` | `add_edge` | `72b03718535b` | `open_moved` | write-time | **`author_of_evidence` hardcoded USER**, `disclosure`, `supersedes` | act | ➡️ **MOVED to `0003` §1b (M7).** Resolved there: inherit the corrected edge's class | tracked as 0003 I10 [M7-correct] |
| `src/veracium/__init__.py:639` | `Memory.correct()` | `add_episode` | `23255a7f3c3f` | `open_moved` | write-time | episode provenance | act | ➡️ moved with M7 | tracked as 0003 I10 [M7-correct] |
...
| `src/veracium/graph.py:141` | `apply_supersession()` | `invalidate_edge` | `cda8875a699c` | `open_moved` | write-time | `active`, reason `superseded` | observation | ➡️ **`0003`** — cross-class supersession; unfiltered today | tracked as 0003 I1/I2 [M7-correct] |
...
| `src/veracium/portability.py:91` | `import_memory()` | `add_edge` | `b1f56bc283b7` | `open_moved` | write-time | **every trust field, reconstructed from a file** | transfer | ➡️ **MOVED to `0005`.** No capping on the `user_id` remap | tracked as 0005 P1–P4 [M6-import] |
| `src/veracium/portability.py:98` | `import_memory()` | `add_episode` | `bab7d192c8f8` | `open_moved` | write-time | episode provenance from a file | transfer | ➡️ moved with M6 | tracked as 0005 P1–P4 [M6-import] |
