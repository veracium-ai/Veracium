...
CLOSURES = [
    ...
    ("0031", "external", 1, '0031-R1-4',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_proposal_cell tests/test_0031_proposal_ddl.py::test_resolution_cell -q -p no:randomly'),
    ...
    ("0031", "external", 1, '0031-R1-6',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_proposal_cell -q -p no:randomly'),
    ...
    ("0031", "external", 2, '0031-R2-5',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_resolution_cell tests/test_0031_proposal_ddl.py::test_fk_is_inert_without_the_pragma__control -q -p no:randomly'),
    ...
    ("0031", "external", 3, '0031-R3-5',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_resolution_cell -q -p no:randomly'),
    ("0031", "external", 3, '0031-R3-6',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_proposal_cell tests/test_0031_proposal_ddl.py::test_fk_holds_under_the_pinned_store_opening_sequence tests/test_0031_proposal_ddl.py::test_todays_store_lacks_the_pragma__the_obligation_is_real -q -p no:randomly'),
    ...
    ("0031", "external", 4, '0031-R4-2',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_resolution_ledger_gate -q -p no:randomly'),
    ...
    ("0031", "external", 4, '0031-R4-4',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_connection_path_inventory_is_complete -q -p no:randomly'),
    ...
    ("0031", "external", 4, '0031-R4-6',
     ...
     'bash corpus/rerun.sh  # from the extracted review package; asserts import-origin inside the corpus'),
    ...
    ("0031", "external", 5, '0031-R5-2',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_dynamic_sqlite_acquisition_is_refused__controls -q -p no:randomly'),
    ("0031", "external", 5, '0031-R5-3',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_surrogate_text_raises_through_the_driver__mechanism -q -p no:randomly'),
    ("0031", "external", 6, '0031-R6-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_captured_connect_reference_is_refused__controls -q -p no:randomly'),
    ("0031", "external", 7, '0031-R7-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_connection_constructors_and_submodules_refuse__controls tests/test_0031_proposal_ddl.py::test_every_runtime_opener_spelling_is_refused__matrix -q -p no:randomly'),
    ("0031", "external", 8, '0031-R8-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_evaluated_annotation_acquisition_is_refused__controls -q -p no:randomly'),
    ("0031", "external", 9, '0031-R9-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_string_annotations_apply_the_surface_recursively__controls -q -p no:randomly'),
    ("0031", "external", 10, '0031-R10-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_acquisition_is_classified_by_provenance_not_spelling__controls tests/test_0031_proposal_ddl.py::test_type_alias_values_are_annotation_positions__controls -q -p no:randomly'),
    ("0031", "external", 11, '0031-R11-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_capability_discovery_form tests/test_0031_proposal_ddl.py::test_capability_discovery_inventory_is_mechanically_checked -q -p no:randomly'),
    ...
    ("0031", "external", 13, '0031-R13-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_receiver_names_do_not_determine_runtime_type__control tests/test_0031_proposal_ddl.py::test_the_legitimate_project_site_is_literal_and_clean__control tests/test_0031_proposal_ddl.py::test_sibling_exemptions_rest_on_documented_semantics__controls -q -p no:randomly'),
    ("0031", "external", 14, '0031-R14-1',
     ...
     'PYTHONPATH=src $PY -m pytest tests/test_0031_proposal_ddl.py::test_identical_literal_names_differ_by_receiver__control tests/test_0031_proposal_ddl.py::test_getattr_allowances_sweep_both_directions -q -p no:randomly'),
