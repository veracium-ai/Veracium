...
| | |
|---|---|
| **Author / session** | research (veracium-research); adopted by dev (lineage per the cells; v20 = the round-8 fold — adopted 2026-09-02, the round-9 shared baseline; frozen from adoption to seal) |
