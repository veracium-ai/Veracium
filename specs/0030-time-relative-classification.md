...
| | |
|---|---|
| **Author / session** | research (veracium-research); adopted by dev (lineage per the cells; v23 = the round-11 fold — adopted 2026-09-02, the round-12 shared baseline; frozen from adoption to seal) |
