...
| | |
|---|---|
| **Author / session** | research (veracium-research); adopted by dev (lineage per the cells; v19 = the round-7 fold — adopted 2026-09-02, the round-8 shared baseline; frozen from adoption to seal) |
