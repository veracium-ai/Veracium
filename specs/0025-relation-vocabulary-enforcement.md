...
| PHASE 2 (store) | digest × snapshot × domain — the full product | the full matrix incl. snapshot-absent (`plan.raw_request=None` is legal) and the identity-less outcome rule | — |
