...
| markers collection | JSON array of strings, at most 16 entries |
| marker string length | 1–64 characters |
| duplicate markers | REFUSE |
| direction (CLOSED) | `inbound, outbound, ambiguous` |
...
closed keys, a JSON array of at most 16 markers of 1–64 characters
each, duplicates refused, the closed direction enum, a 1–64-character
lexicon version under a closed pattern — rendered into §3d as a
byte-bound generated block, with every bound driven at the limit and
one beyond by a standing test.
