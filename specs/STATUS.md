...
| **0004** | derived views must not outlive a revoked trust decision | `draft` | 2026-08-17 | 1 | 0 | 1 | 0 | 1 | 0/1 |
...
| **0022** | source revocation — the standing state and the sweep (A3a) | `draft` | 2026-08-17 | 0 | 0 | 4 | 0 | 0 | — |
| **0023** | non-revival under maintenance — a revoked source cannot re-enter (A3b) | `draft` | 2026-08-17 | 0 | 0 | 5 | 0 | 0 | — |
