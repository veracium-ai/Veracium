...
**18 specs · 12 accepted · 157 external review
rounds · 2 blocking questions open.**

**Only `accepted` authorises implementation** (`PROCESS.md` §4a), and external
review is required to reach it. **12 of 18 are accepted**, which
...
| **0005** | import has no trust boundary | `draft` | 2026-08-13 | 1 | 1 | 1 | 0 | 2 | 0/2 |
...
| **0017** | token-usage telemetry over the Metered wrapper | `draft` | 2026-08-14 | 1 | 10 | 0 | 0 | 0 | — |
| **0018** | the release-migration orchestrator | `accepted` | 2026-08-13 | 1 | 4 | 0 | 0 | 0 | — |
