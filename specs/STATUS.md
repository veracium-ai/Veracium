...
**26 specs · 24 accepted · 331 external review
rounds · 0 blocking questions open.**

**Only `accepted` authorises implementation** (`PROCESS.md` §4a), and external
review is required to reach it. **24 of 26 are accepted**, which
...
| **0011** | subject-scoped entitlement | `accepted` | 2026-08-29 | 2 | 19 | 0 | 0 | 1 | 1/1 |
...
| **0026** | label/value agreement check | `draft` | 2026-08-30 | 11 | 10 | 2 | 0 | 0 | — |
