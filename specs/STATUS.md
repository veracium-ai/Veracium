...
**19 specs · 14 accepted · 176 external review
rounds · 2 blocking questions open.**

**Only `accepted` authorises implementation** (`PROCESS.md` §4a), and external
review is required to reach it. **14 of 19 are accepted**, which
...
| **0019** | the `ungrounded` flag — evidence-grounding at ingest | `draft` | 2026-08-14 | 1 | 5 | 0 | 0 | 0 | — |
