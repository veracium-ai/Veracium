...
| **0011** | subject-scoped entitlement | `accepted` | 2026-08-30 | 2 | 19 | 0 | 0 | 1 | 1/1 |
...
| **0022** | source revocation — the standing state and the sweep (A3a) | `accepted` | 2026-08-25 | 4 | 21 | 5 | 0 | 0 | — |
...
| **0029** | transaction-time carrier | `draft` | 2026-08-31 | 0 | 0 | 0 | 0 | 0 | — |
| **0030** | time-relative trust classification | `draft` | 2026-08-31 | 0 | 0 | 0 | 0 | 0 | — |
| **0031** | the agent-facing trust surface | `draft` | 2026-08-31 | 0 | 0 | 0 | 0 | 0 | — |
