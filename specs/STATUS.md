...
**21 specs · 15 accepted · 187 external review
rounds · 2 blocking questions open.**

**Only `accepted` authorises implementation** (`PROCESS.md` §4a), and external
review is required to reach it. **15 of 21 are accepted**, which
...
| **0020** | scoped recall — the principal boundary (S1) | `draft` | 2026-08-16 | 1 | 11 | 0 | 0 | 0 | — |
| **0021** | scope under derivation and consolidation (S2) | `draft` | 2026-08-16 | 1 | 11 | 0 | 0 | 0 | — |
