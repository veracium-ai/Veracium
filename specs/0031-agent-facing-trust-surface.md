...
| **Author / session** | research (veracium-research); adopted by dev (v4-v12 per the cells; v13 = the round-7 fold — adopted 2026-09-03, the round-8 pin; frozen from adoption to seal) |
...
- `sqlite3.Connection` — legal ONLY in annotation position; as a Call's func
  it IS an opener and refuses; captured anywhere else it refuses;
