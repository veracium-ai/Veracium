...
| the host-owned migration attestation (caller-supplied) | — | — | — | — | **moved to 0018 by the round-14 split** — the full contract, its validation cells, and `test_attestation_contract` live there; 0016 keeps only the POLICY that a D2 migration requires host-attested quiescence and backup |
