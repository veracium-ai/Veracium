...
FINDINGS = [
    ...
    dict(id="M9", title="reinforcement transfers `observed_at`/`confidence` unattributed",
         ...
         current_defect="a compromised/revoked source that reinforced a fact left no attribution, so its contribution to the survivor's currency and confidence cannot be found or undone — unattributed state transfer in a provenance product (research A3 §2.1, 2026-08-07)"),
