...
CITATION_DEBT: dict = {
    ...
    "0039": {
        "test_a_raising_callback_changes_nothing_at_any_site": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_an_absent_volatility_key_writes_nothing": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_cause_is_a_closed_vocabulary_and_a_provider_exception_name_never_reaches_the_log": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_drifted_volatility_writes_one_record_with_the_count": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_each_record_carries_exactly_its_declared_fields": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_every_cli_memory_construction_attaches_a_reporter": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_no_site_calls_the_callback_directly": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_record_degrade_never_sends_inline": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_recording_never_changes_the_outcome": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_retry_failure_writes_one_record": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_the_answer_matrix_holds_on_both_call_sites": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_the_census_names_every_continuing_handler": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_the_raising_primary_shapes_log_the_degrade_then_the_error": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_the_record_carries_no_content": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_unparseable_writes_one_record": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation",
        "test_volatility_records_aggregate_per_call": "owed_at_implementation: an OWED node of accepted 0039 (round 4, 2026-09-10) \u2014 the reviewer's \"named OWED tests \u2026 remain mandatory implementation obligations\"; lands in tests/test_0039_degradation_visibility.py with the implementation"
    }
}
