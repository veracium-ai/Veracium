...
```
corpus sha256: 8bbc1a4445b948c60b2b6c460bd7621b8c58bb5d05b899506c6d8b06c937fa34
```
...
`proposals/0038-oracle-labelling/verb_registry.py`, **published sha16 `5dcd1ee1e7ec2a6d`**, rulings sha16 **`af7823c7ac15152f`** *(method: `ast.unparse` of the parsed
...
marker, and the exemptions **as JSON a check can read**, in
`known_foreign_digests`' shape — because **an exemption in prose is an
exemption nobody can check.**
...
oracle manifest sha256: 8f197b385db6c679e820f1a84f31907a31c9ecc8c6810c2112bcc7ef8e496a9a
...
| 8 | **registry v2** — published `5dcd1ee1e7ec2a6d`, rulings `af7823c7ac15152f` | two carries, each settled by the run at step 5–6, **not** by re-reading |
